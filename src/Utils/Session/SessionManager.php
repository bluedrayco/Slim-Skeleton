...
class SessionManager
{
    ...
    protected function createFileDriver()
    {
        ...
        return $this->buildSession(new FileSessionHandler($this->filesystem, $path,120));
    }

    protected function createDatabaseDriver()
    {
        $table = $this->app->config('sessions.table');
        return $this->buildSession(new DatabaseSessionHandler($this->dbConnection, $table,120));
    }
